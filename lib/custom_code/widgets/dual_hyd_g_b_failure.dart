...
class DualHydGBFailure extends StatefulWidget {
  const DualHydGBFailure({
    Key? key,
    this.width,
    this.height,
    this.imagePath,
  ...
  @override
  _DualHydGBFailureState createState() => _DualHydGBFailureState();
}

class _DualHydGBFailureState extends State<DualHydGBFailure> {
  ...
  // لون مخصص يميز الـ Green + Blue
  final Color gbAccent =
      const Color(0xFF0D9488); // لون Teal يعبر عن دمج الأخضر والأزرق
      ...
      child: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // تمييز الـ G+B SYS LOW بشكل واضح ولون مختلف عن الـ G+Y
                  Container(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 12.0, vertical: 6.0),
                    decoration: BoxDecoration(
                      color: gbAccent.withOpacity(0.15),
                      borderRadius: BorderRadius.circular(6.0),
                      border: Border.all(color: gbAccent, width: 1.5),
                    ),
                    child: Text(
                      'HYD G + B SYS LO PR',
                      style: TextStyle(
            ...
            _buildTextGroup(
              mainText: 'HYD G+B SYS LO PR:',
              subItems: [
                'No ailerons – only 1 elevator – few spoilers – only REV 2 – no slats !',
                'No AP – A/THR unreliable (due to loss of slats and most flight controls).',
            ...
            _buildTextGroup(
              ...
              subItems: [
                'Virtually NO flight controls ! (No ailerons – only 1 elevator – few spoilers – no slats).',
                'Braking capacities OK (Y HYD available) !',
                'ALTN brakes only – no autobrake – REV 2 only.',
              ],
              bulletColor: alertRed,
            ),
            ...
            _buildTextGroup(
              ...
              subItems: [
                ...
                'Extend L/G at 200 kts for controllability with only 1 ELEV.',
              ],
              bulletColor: timelineBlue,
            ),

            _buildTextGroup(
              mainText: 'When L/G down (Early):',
              subItems: [
                'Direct law.',
                '\'USE MAN PITCH TRIM\'.',
            ...
            _buildTextGroup(
              ...
              subItems: [
                ...
                'In ALTN law, ELEV compensated, remain in L/G UP until in CONF 3 & VAPP.',
              ],
              bulletColor: timelineBlue,
            ),
            _buildTextGroup(
            ...
            _buildTextGroup(
              mainText: 'At Touchdown (Long RWY ≥ 2500 m):',
              subItems: [
                'Use only REV 2.',
                'F/O callout GS.',
              ],
            ...
            _buildTextGroup(
              mainText: 'KEYS:',
              subItems: [
                'L/G DN at 200 kts (1 ELEV) !',
                'Virtually no flight controls !',
                'Cabin : full EMER preparation !',
                'No overweight landing !',
                'ALTN brakes only (no A/B) !',
                'Monitored approach !',
                'Low body attitudes (flaps only) !',
              ],
            ),
            _buildTextGroup(
              mainText: 'ATC:',
              subItems: [
                'FULL EMERGENCY !',
                'Straight-in ILS, no non-precision !',
